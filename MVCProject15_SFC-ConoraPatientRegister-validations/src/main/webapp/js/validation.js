...
function validate(frm){
	...
	//read from data 
	 ...
	 if(loc==""){
		 document.getElementById("GndErr").innerHTML="<b> person gender is madatory</b>";
		 //frm.location.focus();
		flag=true;
	 }
	 if(page==""){
	 ...
	 if(hsptl==""){
		 document.getElementById("addErr").innerHTML="<b> address name is mandatory</b>";
		 //frm.hospital.focus();
		 flag=true;
	 }
	 else if(hsptl.length<3 || hsptl.length>12){
		 document.getElementById("addErr").innerHTML="<b> address name must have min 3 chars and max of 12 chars</b>";
		 //frm.hospital.focus();
		flag=true;
	 }
